...
export const TestimonialSection: React.FC<TestimonialSectionProps> = ({
  ...
  return (
    <section 
      className={`scroll-reveal-text-block overflow-hidden px-6 md:px-[5%] py-16 md:py-24 lg:py-42 bg-cover bg-center bg-no-repeat relative ${className}`}
      style={{
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        <h3 ref={headingRef} className="text-4xl md:text-5xl font-semibold font-heading text-sunflower-50">
