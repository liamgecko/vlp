    ...
    <footer className="footer-block bg-gradient-to-b from-midnight-950 to-slate-950 text-sunflower-100">
      ...
      <section className="border-t border-slate-800">
        <div className="container mx-auto px-4 py-16">
          ...
          {/* Junebug Badge */}
          <div className="text-center mb-8">
            <h4 className="text-sunflower-50 text-xs mb-4 uppercase tracking-wider font-medium">Junebug approved wedding vendor</h4>
            <div className="flex justify-center">
              <Image
                src="/junebug-weddings-member-badge-2025-white.png"
                alt="Junebug Weddings Member Badge 2025"
                width={140}
                height={140}
                className="h-auto"
              />
